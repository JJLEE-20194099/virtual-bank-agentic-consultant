...
def get_company_info_summary(
    ...
    with open(f"/root/code/hackathons/virtual-bank-agentic-consultant/backend/app/data/company/summary.json", "r", encoding="utf-8") as f:
    ...
    profit_of_equity_holders = get_financial_value("income_statement", "yearly", "xv.net_profit_atttributable_to_the_equity_holders_of_the_bank", "2025")
    profit_before_tax = get_financial_value("income_statement", "yearly", "xi.profit_before_tax", "2025")
